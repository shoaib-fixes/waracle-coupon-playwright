...
[Binding]
public sealed class SessionSteps(BrowserDriver driver, TestSettings settings, LoginPage loginPage, NavbarComponent navbar)
{
    /// <summary>
    ...
    public Task GivenSignedIn() => driver.SeedLocalStorageAsync(StorageKeys.Token, driver.AuthToken);
    ...
    public Task ThenGreetedAs(string firstName) => Assertions.Expect(navbar.Greeting(firstName)).ToBeVisibleAsync();
}
